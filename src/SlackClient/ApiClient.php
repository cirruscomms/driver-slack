...
use BotMan\Drivers\Slack\SlackClient\Message\Message;
use BotMan\Drivers\Slack\SlackClient\Message\MessageBuilder;
...
class ApiClient
{
     ...
     *
     * @return PromiseInterface A promise for the currently authenticated user.
     */
     ...
     *
     * @return PromiseInterface A promise for the current Slack team.
     */
     ...
     *
     * @return PromiseInterface A promise for a channel interface.
     */
     ...
     *
     * @return PromiseInterface A promise for a channel object.
     */
     ...
     *
     * @return PromiseInterface A promise for a group object.
     */
     ...
     *
     * @return PromiseInterface A promise for a DM object.
     */
     ...
     *
     * @return PromiseInterface A promise for an array of users.
     */
     ...
     * @param string $id A user ID.
     *
     * @return PromiseInterface A promise for a user object.
     */
